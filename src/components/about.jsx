        ...
        <div className="about-content">
            ...
            <article className="contents">
                ...
                <div className="about-text">
                    <p className='hidden text-focus-in'>Valorant é um jogo de tiro tático em primeira pessoa desenvolvido e publicado pela Riot Games. Lançado em junho de 2020, o jogo é gratuito e combina elementos de jogos de tiro clássicos com habilidades únicas de personagens, conhecidos como "Agentes".</p>

                    <p className='hidden text-focus-in'>Valorant se aproveita de um tipo de jogo que está em alta no momento. Trata-se de um FPS tático em que cinco jogadores batalham contra outros cinco visando plantar ou desarmar a chamada Spike. Cada player tem apenas uma única vida por rodada (em um total de 25) e a equipe que ganhar 13 rodadas primeiro se consagra como a vencedora.</p>

                    <p className='hidden text-focus-in'>
